                ...
                while ($lastBlog->have_posts()): $lastBlog->the_post(); ?>
                    <div class="row">
                        <div class="col-md-6 blog-col-img">
                            <a href=<?php echo get_permalink(get_option('page_for_posts')); ?> style="background-image:url(<?php the_post_thumbnail_url('full'); ?>)"
                               class="slide-featured-image"></a>
                        </div>
                        <div class="col-md-5 blog-col-content">
                            ...
                            <a href=<?php echo get_permalink(get_option('page_for_posts')); ?>>
                                <button class="blog-col-btn">Read More</button>
                            </a>
